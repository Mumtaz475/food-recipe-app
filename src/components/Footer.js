...
const Footer = () => {
  return (
    <div className='max-w-[1480px] m-auto py-4 px-2 bg-[#24262b]'>
        <div className='py-10 px-4 grid lg:grid-cols-3 gap-8 text-gray-300'>
            <div>
                ...
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima explicabo quod molestias non molestiae nulla voluptatem dolore maxime cum aut?
                </p>
            ...
            <div className='lg:col-span-2 flex justify-between mt-6'>
                <div>
                <h6 className='font-md text-[#9b9b9b]'>Location</h6>
                <ul>
