...
const NewsLetter = () => {
  return (
    <div className='max-w-[1480px] m-auto text-white px-4 bg-[#24262b]'>
      <div className='max-auto grid lg:grid-cols-3'>
        ...
        <div className='my-4'>
            <div className='flex flex-col sm:flex-row items-center justify-between w-full'>
                ...
                <button className='bg-[#00df9a] text-white rounded-md font-md w-[200px] ml-4 my-6 px-3 py-3 border-none'>
                    Notify me
                </button>
            </div>
